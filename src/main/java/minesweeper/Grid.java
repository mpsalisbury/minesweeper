...
public class Grid {
	...
	private static class Cell {
		...
		enum CellState {
			BOMB_0, BOMB_1, BOMB_2, BOMB_3, BOMB_4, BOMB_5, BOMB_6, BOMB_7, BOMB_8, HAS_BOMB;
			public static CellState getBombCountState(int bombCount) {
				switch (bombCount) {
					case 0: return BOMB_0;
					case 1: return BOMB_1;
					...
					default: throw new IllegalArgumentException("Bad Bombcount " + bombCount);
				}
			}
			...
			public String toString() {
				switch (this) {
					case BOMB_0: return "/ ";
					case BOMB_1: return "1 ";
					case BOMB_2: return "2 ";
					case BOMB_3: return "3 ";
					case BOMB_4: return "4 ";
					case BOMB_5: return "5 ";
					case BOMB_6: return "6 ";
					case BOMB_7: return "7 ";
					case BOMB_8: return "8 ";
					case HAS_BOMB: return "X ";
					default: return "xx";
				}
			}
		}
